$(document).ready(function(){
    ...
    var card1 = new Card('Zakupy :)'); 
    var card2 = new Card('Zatankowac samochod');
    var card3 = new Card('Nuaka japonskiego');
    var card4 = new Card('Tenis obejrzec');
    var card5 = new Card('Umyc się') 
